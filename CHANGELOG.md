...
- Retained the native restoration HUD with confirmation of the actual input route.
- Included English and Simplified Chinese, isolated UI previews, and 33 regression tests.
